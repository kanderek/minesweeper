module.exports = function (grunt) {
    ...
    concat: {
        ...
        dist: {
          src: ['js/Grid.js', 'js/Timer.js', 'js/MineField.js', 'js/MineSweeper.js', 'js/app.js'],
          dest: 'js/main.js',
        }
    },
    cssmin: {
    ...
    'ftp-deploy': {
      build: {
        ...
        src: 'build',
        dest: '/home/derek/public_html/minesweeper',
        exclusions: []
      }
    },
    copy: {
...
grunt.registerTask('default', ['jasmine', 'concat', 'uglify', 'cssmin']);
